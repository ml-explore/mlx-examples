...
- Gökdeniz Gülmez: Added support for `MiniCPM`, `Helium`, `Mamba version 1` and support for `full-fine-tuning`, `Direct Preference Optimization (DPO)`, and `Odds Ratio Preference Optimization (ORPO)`.