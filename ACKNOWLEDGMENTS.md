...
- Gökdeniz Gülmez: Added support for `MiniCPM`, `Mamba version 1`, `helium` and support for `full-fine-tuning`, `Direct Preference Optimization (DPO)`, and `Offline Reward Policy Optimization (ORPO)`.