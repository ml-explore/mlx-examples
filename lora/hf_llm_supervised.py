...
def generate_outer(model, prompt, tokenizer, max_tokens, temp):
    prompt = tokenizer(
        prompt,
        return_tensors="np",
...
class HFTrainingRecordHandler(TrainingRecordHandler):
    def get_input(self, record) -> str:
        raise NotImplemented("Need to implement HF generic dataset format")
...
if __name__ == "__main__":
    main(HFTrainingRecordHandler(), load, generate_outer)
