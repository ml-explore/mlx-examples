...
hf_clip = transformers.CLIPModel.from_pretrained(MODEL)
hf_processor = transformers.CLIPProcessor.from_pretrained(MODEL)
...
with torch.inference_mode():
    torch_out = hf_clip(**clip_input, return_loss=True)
