"""Generate videos from text using Cosmos 3 Nano on MLX."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate videos from text using Cosmos 3 Nano"
    )
    ...
    # Generate latents
    print(f"\nGenerating {width}x{height} {args.frames}-frame video...")
